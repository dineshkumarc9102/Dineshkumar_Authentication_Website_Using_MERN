...
export const register = async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            ...
            to: email,
            subject: 'Welcome',
            text: `Hi Buddy Welcome to Dinesh Kumar Website. Your account has been created with email id: ${email}`
        }
...
export const resetPassword = async (req, res) => {
    ...
    try {
        ...
        return res.json({success: true, message: "Password has beed reset successfully"})
